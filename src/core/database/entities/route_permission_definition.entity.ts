...
export class Route_permission_definition {
  ...
  isEnabled: boolean;
  @ManyToMany('User_definition', (rel: any) => rel.allowedRoutePermissions, {
    nullable: true,
    cascade: true,
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  ...
  @JoinTable()
  allowedUsers: any;
  @ManyToOne('Role_definition', (rel: any) => rel.routePermissions, {
    nullable: true,
    onDelete: 'SET NULL',
    onUpdate: 'CASCADE',
  })
  @JoinColumn()
  role: any;
  @ManyToOne('Route_definition', (rel: any) => rel.routePermissions, {
    nullable: true,
    onDelete: 'SET NULL',
    onUpdate: 'CASCADE',
  })
  @JoinColumn()
  route: any;
  @ManyToMany('Method_definition', (rel: any) => rel.route_permissions, {
    nullable: true,
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  })
