...
export class Method_definition {
  ...
  method: string;
  @ManyToMany('Route_permission_definition', (rel: any) => rel.methods, {
    nullable: true,
    cascade: true,
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  ...
  @ManyToMany('Route_definition', (rel: any) => rel.publishedMethods, {
    nullable: true,
    cascade: true,
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  ...
  @JoinTable()
  routes: any;
  @OneToMany('Route_handler_definition', (rel: any) => rel.method, {
    cascade: true,
  })
  handlers: any;
  @ManyToMany('Hook_definition', (rel: any) => rel.methods, {
    nullable: true,
    onDelete: 'CASCADE',
    onUpdate: 'CASCADE',
  })
